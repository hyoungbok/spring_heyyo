	...
	<form name="frm" method="post">
		...
		<table border="0" cellspacing="0" cellpadding="2" align="center">
			<tr>
				...
				<li><a href="agree4.html"><span>위치기반 </span><span>서비스 </span><span>이용약관</span></a>
				</li></ul></div><textarea rows="50" cols="100" readonly="readonly">요기요 이용약관


제1조 (목적)
본 약관은 유한회사 알지피코리아(이하 “회사”라 함)가 운영하는 "요기요" 사이트(www.yogiyo.co.kr) 또는 “요기요” 모바일 애플리케이션에서 제공하는 서비스(이하 "서비스"라 함)를 이용함에 있어 ”요기요”와 이용자의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.
...
3. 기타 "요기요"가 정하는 업무
② "요기요"는 음식 또는 용역의 품절 또는 기술적 사양의 변경 등의 사유가 발생하는 경우 장차 체결되는 계약에 의해 제공할 요기요서비스의 내용을 변경할 수 있으며, 오로지 가맹점의 사정(가맹점의 고의나 과실로 “요기요” 사이트에 음식메뉴 업데이트가 이루어지지 않는 것을 포함하나 이에 한하지 아니함)으로 인해 해당 관련 서비스의 중단이 불가피한 사정이 있는 경우에는 이미 체결된 계약의 해당 주문 건에 대한 서비스를 개별적으로 중단할 수 있습니다. 위 각 경우에는 변경된 음식·용역의 내용 및 제공일자를 명시하여 현재의 음식 ∙ 용역의 내용을 게시한 곳에 즉시 공지합니다.
...
③ 요기요 서비스의 치신정보와 혜택 수신을 원하는 경우에는 전자우편/ 서신우편/ 문자메시지/ 앱푸쉬 등의 매체로 받아보실 수 있습니다.
...
5. 요기요서비스를 이용하여 구입한 상품 등의 대금, 기타 메뉴 몰의 이용에 관련하여 회원이 부담하는 채무를 기일 내에 지급하지 않는 경우
...
④ "요기요"가 회원자격을 상실 시키는 경우에는 회원등록을 말소합니다. 본 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한 30일 이상의 기간을 정하여 소명할 기회를 부여합니다.
...
① "요기요"는 "요기요" 연결 사이트가 취급하는 상품 또는 용역에 대하여 보증책임을 지지 않습니다.
...
5. 음식의 구매신청 및 이에 관한 확인 또는 “요기요”의 확인에 대한 동의
6. "결제방법의 선택

제13조 (계약의 성립)
① "요기요"는 다음 각호에 해당하는 경우 제12조의 구매신청을 승낙하지 않을 수 있습니다.
...
제14조 (이용자의 대금지급방법)
“요기요”에서 구매한 음식 또는 용역에 대한 대금지급방법은 다음 각호의 방법 중 가용한 방법으로 할 수 있습니다. 단, “요기요”는 이용자의 지급방법에 대하여 음식 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.
...
③ "요기요"는 이용자가 구매한 상품이 시간을 초과하여 배달되거나 약속한 시간 내에 배달되지 않음으로 인한 이용자의 손해를 배상할 의무가 없으며 배달지연에 대한 책임은 가맹점에서 집니다.
④ 해당 가맹점의 고의 또는 과실로 약정 배달시간을 초과한 경우에는 그로 인한 이용자의 손해를 해당 가맹점에서 배상합니다.

제17조 (환불, 반품 및 교환)
① "요기요"는 이용자가 구매 신청한 상품을 부득이 한 사정으로 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고, 이미 상품대금을 받은 경우에는 대금을 받은 후 3일 이내에 환급절차를 취합니다.
...
제19조 ("요기요"의 의무)
① "요기요"는 법령과 본 약관이 금지하거나 공서양속(사회의 일반적 도덕 및 기타 사회의 공공적 질서)에 반하는 행위를 하지 않으며 본 약관이 정하는 바에 따라 지속적이고, 안정적으로 음식·용역을 제공하는 데 최선을 다하여야 합니다.
② "요기요"는 이용자가 안전하게 인터넷 서비스를 이용할 수 있도록 이용자의 개인정보(신용정보 포함)보호를 위한 보안 시스템을 갖추어야 합니다.
③ "요기요"의 상품이나 용역에 대해 “요기요”의 고의 또는 과실로 인하여 「표시·광고의 공정화에 관한 법률」 제3조 소정의 부당한 표시·광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다. 단, 가맹점의 부당한 표시 ∙ 광고행위로 인한 이용자의 손해에 대해서는 “요기요”가 책임을 부담하지 아니합니다.
...
"요기요"는 “요기요” 연결 사이트가 독자적으로 제공하는 음식·용역에 의하여 이용자와 행하는 거래에 대해서 보증책임을 지지 않는다는 뜻을 "요기요"의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한 경우에는 그 거래에 대한 보증책임을 지지 않습니다.
...
② “요기요”는 이용자와 가맹점 간의 음식 구매계약에 대해 중개대행 서비스를 제공할 뿐이므로, 이용자가 가맹점으로부터 구매하신 음식 또는 용역의 품질이나 가맹점의 신뢰도에 대해서는 보증하지 않습니다.
③ “요기요”는 이용자가 가맹점으로부터 구매한 음식 또는 용역에 대해 보증하거나 별도의 책임을 지지 않으며, 음식 또는 용역과 관련한 일체의 책임은 가맹점에게 있습니다.
