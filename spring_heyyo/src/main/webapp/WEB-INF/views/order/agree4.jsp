...
위치기반서비스 이용약관
제1조 (목적)
본 약관은 이용자(요기요 서비스를 이용하는 모든 사람을 말합니다. 이하 “이용자”라고 합니다.)가 유한회사 알지피코리아(이하 “회사”라고 합니다.)가 제공하는 요기요 서비스(이하 “서비스”라고 합니다.)를 이용함에 있어 회사와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
제 2 조 (이용약관의 효력 및 변경)
...
① 본 약관은 온라인에서 요기요 서비스를 통해 본 약관에 동의함으로써 효력이 발생합니다.
...
1. 상호 : 유한회사 알지피코리아
2. 대표자: 강신봉
3. 주소 : 서울특별시 강남구 테헤란로 5길 7 KG타워 10~12층 (우: 135-932)
4. 대표전화: 02-3447-3612
부칙
제 1조 (시행일) 이 약관은 2018년 10월 1일부터 시행한다.
제 2조 위치정보관리책임자는 2017년 7월 15일을 기준으로 다음과 같이 지정합니다.
1. 이름 : 조현준
2. 연락처 : 02-3447-3612
