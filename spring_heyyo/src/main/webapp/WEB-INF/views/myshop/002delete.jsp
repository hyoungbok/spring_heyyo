...
<div  style="margin-left:20%; margin-top: 50px;">
	<h2><p>삭제</p></h2>
	<button onclick="location.href='../myshop/002'"> 삭제끝내기</button>
</div>
...
<div  style="margin-left:25%; margin-top:5%;">
		...
		<div class="table1" style="color: #666666;">
			...
			<p class="p"> 기본 세트 1 (후라이드 + 양념)
				<img alt="" src="mg/chicken.png" style=" width: 80px; height: 30px;">
				<br><button type="button"  onclick="mdelete()">삭제</button>
			</p>
			<p class="p"> 기본 세트 2 (간장 + 양념)
				<img alt="" src="img/chicken.png" style=" width: 80px; height: 30px;">
			</p>
			<p class="p"> 기본 세트 3 (후라이드 + 땡초)
				<img alt="" src="img/chicken.png" style=" width: 80px; height: 30px;">
			</p>
			<p class="p"> 기본 세트 4 (간장 + 땡초)
				<img alt="" src="img/chicken.png" style=" width: 80px; height: 30px;">
			</p>
			</div>
		 	<button class="accordion">메뉴 2</button>
			<div class="panel" style="text-align: left;">
			<p class="p"> 메뉴 등록 해야되는데.... 
