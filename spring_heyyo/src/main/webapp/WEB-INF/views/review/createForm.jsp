	...
	<table>
		...
		<tr>
			...
			사용가능 |</span></label>&nbsp;&nbsp; 
					...
					<i class="icon-check"> &nbsp;※ 직접입력하기&nbsp;<input class="pointchecks"
						type="text" name="o_mileage" value="${dto.o_mileage>0}" placeholder=" 숫자만 입력해주세요"
		...
		<tr>
			<td><input type="checkbox" name="cb2" class="ab"> <label>저기요
					이용약관에 동의합니다. &nbsp;&nbsp;<a href="/order/agree1">(전문보기)</a>
			</label></td>
		</tr>
		<tr>
			<td><input type="checkbox" name="cb3" class="ab"> <label>개인정보
					수집 및 이용에 동의합니다. &nbsp;&nbsp;<a href="/order/agree2">(전문보기)</a>
			</label></td>
		</tr>
		<tr>
			<td><input type="checkbox" name="cb4" class="ab"> <label>개인정보
					제3자 제공에 동의합니다. &nbsp;&nbsp;<a href="/order/agree3">(전문보기)</a>
			</label></td>
		</tr>  
